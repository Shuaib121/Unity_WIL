	...
	public class UIScreenMain : UIScreen
	{
		...
		public override void OnShowing(object data)
		{
			...
			else
			{
				...
				{
					continueBtnTopText.text = "AANHOU";
				}
			...
			{
				continueBtnBottomText.text = string.Format("{0} VLAK {1}", contineCategoryInfo.displayName.ToUpper(), continueBtnLevelIndex + 1);
			}
